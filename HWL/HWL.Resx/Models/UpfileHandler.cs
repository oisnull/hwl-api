...
//    {
//        private List<IFormFile> fileKeys;
//        private List<IFormFile> files = null;

//        public UpfileHandler(List<IFormFile> fileKeys, ResxModel resxModel) : base(resxModel)
//        {
...
//            }
//            files = new List<IFormFile>(fileKeys.Count);
